...
const OurStory = () => {
  const storylines = [
    "After my last year of high school I decided to start working as a freelancer ",
    "I decided along side my partner in seven to create this team as a freelancing team ",
    "We started offering our services to the local business and offer them many ways that we can help them improve their visual work ",
    "We decided to rebrand the team to a production team that work on a higher scale and on bigger projects to supply more clients and produce more content",
